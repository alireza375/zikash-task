                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="mx-auto position-relative">
                                <input class="px-4 py-3 border-0 form-control w-100 rounded-pill" type="number" placeholder="Your Email">
                                <button type="submit" class="px-4 py-3 text-white border-0 btn btn-primary border-secondary position-absolute rounded-pill" style="top: 0; right: 0;">Subscribe Now</button>
                            </div>
                        </div>
                        <div class="col-lg-3">
